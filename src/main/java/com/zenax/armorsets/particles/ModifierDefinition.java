...
public class ModifierDefinition {
    ...
    public void apply(List<Location> points, Location center, double progress, Map<String, Object> params) {
        ...
        switch (id.toLowerCase()) {
            ...
            case "pulse" -> applyPulse(points, center, progress, speed, amount);
    ...
    private void applyPulse(List<Location> points, Location center, double progress, double cyclesPerSecond, double amount) {
