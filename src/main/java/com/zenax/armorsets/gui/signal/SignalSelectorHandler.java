package com.zenax.armorsets.gui.signal;
...
public class SignalSelectorHandler extends AbstractHandler {
    ...
    private void handleBack(Player player, GUISession session) {
        ...
        com.zenax.armorsets.flow.FlowConfig flowConfig = session.get("flowConfig", com.zenax.armorsets.flow.FlowConfig.class);
        ...
        if (returnToSettings != null && returnToSettings) {
            ...
            com.zenax.armorsets.gui.flow.FlowBuilderHandler.openGUI(guiManager, player, sigil,
            ...
            com.zenax.armorsets.gui.flow.FlowBuilderHandler.openGUI(guiManager, player, sigil, oldSignalKey);
        } else {
    ...
    private void handleSignalSelect(Player player, GUISession session, Sigil sigil, int slot, int page) {
        ...
        if (flowConfig == null) {
            ...
            flowConfig = new com.zenax.armorsets.flow.FlowConfig(com.zenax.armorsets.flow.FlowType.SIGNAL);
    ...
    public static void openGUI(GUIManager guiManager, Player player, Sigil sigil, int page, String currentTrigger,
                               com.zenax.armorsets.flow.FlowConfig flowConfig, boolean returnToSettings) {
        if (sigil == null) {
    ...
    private static ItemStack buildSignalTypeItem(SignalType signalType, Sigil sigil) {
        ...
        if (sigil.hasFlow()) {
            com.zenax.armorsets.flow.FlowConfig existingFlow = sigil.getFlow();
